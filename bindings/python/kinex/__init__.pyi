...
class RobotModel:
    ...
    @staticmethod
    def from_urdf_string(xml: str) -> RobotModel: ...
...
class Robot:
    ...
    @staticmethod
    def from_urdf(filepath: str, end_link: str, base_link: str = "") -> Robot: ...
    @staticmethod
    def from_urdf_string(urdf_string: str, end_link: str, base_link: str = "") -> Robot: ...
    
    def clone(self) -> Robot: ...
    
    def forward_kinematics(self, q: np.ndarray, link: str = "") -> Transform: ...
    def compute_pose(self, q: np.ndarray, link: str = "") -> Transform: ...
    
    def inverse_kinematics(self, target: Transform, q_init: np.ndarray, link: str = "") -> Tuple[np.ndarray, SolverStatus]: ...
    def solve_ik(self, target: Transform, q_init: np.ndarray, link: str = "") -> Tuple[np.ndarray, SolverStatus]: ...
    
    def compute_jacobian(self, q: np.ndarray, link: str = "", type: JacobianType = JacobianType.Analytic) -> np.ndarray: ...
    def get_manipulability(self, q: np.ndarray, link: str = "") -> float: ...
    def is_singular(self, q: np.ndarray, threshold: float = 1e-6, link: str = "") -> bool: ...
    def get_condition_number(self, q: np.ndarray, link: str = "") -> float: ...
    
    def set_ik_tolerance(self, tol: float) -> None: ...
    def set_position_only_ik(self, enable: bool) -> None: ...
    def set_orientation_only_ik(self, enable: bool) -> None: ...
...
class URDFParser:
    base_directory: str
    def __init__(self) -> None: ...
    def parse_file(self, filepath: str) -> RobotModel: ...
    def parse_string(self, urdf_string: str) -> RobotModel: ...

class KinematicChain:
    def __init__(self, robot: RobotModel, end_link: str, base_link: str = "") -> None: ...
