...
int main(int argc, char** argv) {
    ...
    try {
        ...
        KINEX_LOG_INFO("Loading robot '{}' with end-effector '{}'", model->getName(), end_link);
        ...
        auto end = std::chrono::high_resolution_clock::now();
          auto duration = std::chrono::duration_cast<std::chrono::microseconds>(end - loop_start);
